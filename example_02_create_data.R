...
saveRDS(df, "sims/example_2/grid.rds")
...
for(k in 1:k_folds) {
  ...
  form = yobs ~ covariate
  if(df$est_model[i]=="null") form = yobs ~ 1
...
# save coefficients
save(fit_model, coef_est,coef_covar, sd_covar,file=paste0("sims/example_2/normal_coefs_",i,".Rdata"))
saveRDS(X, paste0("sims/example_2/normal_pred_",i,".rds"))
